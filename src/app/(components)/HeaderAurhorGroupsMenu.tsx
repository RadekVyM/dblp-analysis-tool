...
export default function HeaderAurhorGroupsMenu() {
    ...
    const [authorGroupsMenuState, setBookmarksMenuState] = useState<AurhorGroupsMenuState>(AurhorGroupsMenuState.Collapsed);
    ...
    useEffect(() => {
        if (!isNotMobile) {
            setBookmarksMenuState(AurhorGroupsMenuState.Collapsed);
        }
    }, [isNotMobile]);

    function bookmarksHoverChanged(isHovering: boolean) {
        if (authorGroupsMenuState != AurhorGroupsMenuState.Docked) {
            setBookmarksMenuState(isHovering ? AurhorGroupsMenuState.Floating : AurhorGroupsMenuState.Collapsed);
        }
    }

    function bookmarksButtonClick() {
        setBookmarksMenuState(authorGroupsMenuState != AurhorGroupsMenuState.Docked ? AurhorGroupsMenuState.Docked : AurhorGroupsMenuState.Collapsed)
    }
    ...
    return (
        <>
            <PageHeader
                ...
                bookmarksMenuState={authorGroupsMenuState}
            ...
            <AurhorGroupsMenu
                ...
                hide={() => setBookmarksMenuState(AurhorGroupsMenuState.Collapsed)} />
        </>
    )
}
