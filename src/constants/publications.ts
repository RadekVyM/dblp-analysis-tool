...
/** Names of colors (their CSS variables) that are asigned to the venue types. */
...
/** Names of colors (their CSS variables) that are asigned to the publication types. */
...
/** Tailwind 'bg' classes that are asigned to the publication types. */
export const PUBLICATION_TYPE_BG = createColorMap('bg');

/** Tailwind 'text' classes that are asigned to the publication types. */
export const PUBLICATION_TYPE_TEXT_COLOR = createColorMap('text');

/** Tailwind 'fill' classes that are asigned to the publication types. */
export const PUBLICATION_TYPE_FILL = createColorMap('fill');

/** Tailwind 'stroke' classes that are asigned to the publication types. */
export const PUBLICATION_TYPE_STROKE = createColorMap('stroke');

/** Titles that are asigned to the publication types. */
...
/** Singular titles that are asigned to the publication types. */
...
/** Titles that are asigned to the venue types. */
