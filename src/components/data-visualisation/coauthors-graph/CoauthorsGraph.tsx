...
function useComputedNodesAndLinks(graph: CoauthorsGraphState, ignoredNodeIds?: Array<string>) {
    ...
    useEffect(() => {
        ...
        // when I run the simulation in the web worker.
        // I do not think I have done anything that could break it.
        // I just experimented with Docker, updated Next.js, removed node_modules folder and that is all.
        // I use the runGraphSimulation() function as a workaround .
