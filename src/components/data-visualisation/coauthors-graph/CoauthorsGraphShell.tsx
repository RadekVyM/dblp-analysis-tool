    ...
    return (
        <div
            ...
            className={cn(
                ...
                '@2xl:grid-rows-[1fr_auto] @2xl:grid-cols-[1fr_minmax(auto,18rem)] @2xl:min-h-[25rem] @2xl:h-[min(80vh,40rem)]',
...
function useFilters(publications: Array<DblpPublication>, onFilteredAuthorsIdsChange: (ids: Set<string>) => void) {
    const { filtersMap, typesFilter, venuesFilter, yearsFilter, authorsFilter, switchSelection, clear, toggleUseAnd } = usePublicationFilters(
        publications,
        {
            ...
            venueFilter: 'Select only authors who contribute to certain venues',
            yearFilter: 'Select only authors who published publications in certain years',
